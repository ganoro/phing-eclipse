...
import org.ganoro.phing.core.IAntClasspathEntry;
...
public class AddCustomDialog extends StatusDialog {
	...
	private String name= IPhingCoreConstants.EMPTY_STRING;
	private IAntClasspathEntry library= null;
	private String className= IPhingCoreConstants.EMPTY_STRING;
	...
	private boolean closeZipFile(ZipFile file) {
		try {
			...
			PhingUi.log(MessageFormat.format(AntPreferencesMessages.AddCustomDialog_Could_not_close_zip_file__0__4, new String[]{file.getName()}), e);
			return false;
		}
	...
	*/
	...
	private MinimizedFileSystemElement createRootElement(Object fileSystemObject, IImportStructureProvider provider) {
		...
		MinimizedFileSystemElement dummyParent =
			new MinimizedFileSystemElement(IPhingCoreConstants.EMPTY_STRING, null, true);
