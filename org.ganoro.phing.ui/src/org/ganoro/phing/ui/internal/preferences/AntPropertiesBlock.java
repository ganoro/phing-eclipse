...
public class AntPropertiesBlock {
	...
	public void createControl(Composite top, String propertyLabel, String propertyFileLabel) {
		...
		dialogSettings= PhingUi.getDefault().getDialogSettings();
	...
	private void addExternalPropertyFile() {
		...
		if (lastUsedPath == null) {
			lastUsedPath= IPhingCoreConstants.EMPTY_STRING;
		}
	...
	private void addProperty() {
		...
		AddPropertyDialog dialog = new AddPropertyDialog(propertyTableViewer.getControl().getShell(), title, new String[]{IPhingCoreConstants.EMPTY_STRING, IPhingCoreConstants.EMPTY_STRING});
