...
public class AntPropertiesPage implements IAntBlockContainer {
	...
	protected void initialize() {
		List allProperties= PhingCore.getPlugin().getPreferences().getDefaultProperties();
		allProperties.addAll(Arrays.asList(PhingCore.getPlugin().getPreferences().getCustomProperties()));
		antPropertiesBlock.setPropertiesInput((Property[]) allProperties.toArray(new Property[allProperties.size()]));
		antPropertiesBlock.setPropertyFilesInput(PhingCore.getPlugin().getPreferences().getCustomPropertyFiles(false));
		antPropertiesBlock.update();
	}
	
	protected void performDefaults() {
		List defaultProperties= PhingCore.getPlugin().getPreferences().getDefaultProperties();
