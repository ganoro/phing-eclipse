 ...
 *******************************************************************************/
package org.ganoro.phing.ui.console;
...
public class AntConsoleColorProvider extends ConsoleColorProvider implements IPropertyChangeListener {
	...
	public Color getColor(String streamIdentifer) {
		if (streamIdentifer.equals(IDebugUIConstants.ID_STANDARD_OUTPUT_STREAM)) {
			return PhingUi.getPreferenceColor(IAntUIPreferenceConstants.CONSOLE_INFO_COLOR);
		}
		if (streamIdentifer.equals(IDebugUIConstants.ID_STANDARD_ERROR_STREAM)) {
			return PhingUi.getPreferenceColor(IAntUIPreferenceConstants.CONSOLE_ERROR_COLOR);
		}				
	...
	public void connect(IProcess process, IConsole console) {
		...
		PhingUi.getDefault().getPreferenceStore().addPropertyChangeListener(this);
	...
	public void propertyChange(PropertyChangeEvent event) {
		...
		if (streamId != null) {
			PhingUi.getStandardDisplay().asyncExec(new Runnable() {
				public void run() {
	...
	public void disconnect() {
		PhingUi.getDefault().getPreferenceStore().removePropertyChangeListener(this);
		super.disconnect();
	}
}
