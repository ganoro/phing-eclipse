...
import org.ganoro.phing.ui.editors.text.AntEditorProcInstrScanner;
import org.ganoro.phing.ui.editors.text.AntEditorTagScanner;
import org.ganoro.phing.ui.editors.text.IAntEditorColorConstants;
import org.ganoro.phing.ui.editors.text.MultilineDamagerRepairer;
...
public class AntSourceViewerConfiguration extends TextSourceViewerConfiguration {
    ...
    public AntSourceViewerConfiguration() {
        super(PhingUi.getDefault().getCombinedPreferenceStore());
    }
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
	    ...
	    xmlCommentAttribute=  new TextAttribute(PhingUi.getPreferenceColor(IAntEditorColorConstants.XML_COMMENT_COLOR), null, style);
	    ...
	    xmlDtdAttribute=  new TextAttribute(PhingUi.getPreferenceColor(IAntEditorColorConstants.XML_DTD_COLOR), null, style);
