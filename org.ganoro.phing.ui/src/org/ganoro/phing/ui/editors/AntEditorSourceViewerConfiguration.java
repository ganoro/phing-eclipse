...
import org.ganoro.phing.ui.AntSourceViewerConfiguration;
import org.ganoro.phing.ui.editors.formatter.XmlDocumentFormattingStrategy;
import org.ganoro.phing.ui.editors.formatter.XmlElementFormattingStrategy;
import org.ganoro.phing.ui.editors.text.AntDocumentSetupParticipant;
import org.ganoro.phing.ui.editors.text.AntEditorPartitionScanner;
import org.ganoro.phing.ui.editors.text.AntInformationProvider;
import org.ganoro.phing.ui.editors.text.NotifyingReconciler;
import org.ganoro.phing.ui.editors.text.XMLAnnotationHover;
import org.ganoro.phing.ui.editors.text.XMLReconcilingStrategy;
...
public class AntEditorSourceViewerConfiguration extends AntSourceViewerConfiguration {
     ...
     */
    public AntEditorSourceViewerConfiguration(PhingEditor editor) {
	    super();
	    fEditor= editor;
    }
	...
	public String[] getIndentPrefixes(ISourceViewer sourceViewer, String contentType) {
		...
		list.add(IPhingCoreConstants.EMPTY_STRING);
    ...
    */
	protected Map getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
		...
		targets.put("org.ganoro.phing.ui.buildFiles", fEditor); //$NON-NLS-1$
		return targets;
	}
}