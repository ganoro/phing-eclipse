...
import org.ganoro.phing.ui.editors.TaskDescriptionProvider.ProposalNode;
import org.ganoro.phing.ui.editors.templates.AntContext;
import org.ganoro.phing.ui.editors.templates.AntTemplateAccess;
import org.ganoro.phing.ui.editors.templates.AntTemplateInformationControlCreator;
import org.ganoro.phing.ui.editors.templates.AntTemplateProposal;
import org.ganoro.phing.ui.editors.templates.BuildFileContextType;
import org.ganoro.phing.ui.editors.templates.TargetContextType;
import org.ganoro.phing.ui.editors.templates.TaskContextType;
import org.ganoro.phing.ui.internal.dtd.IAttribute;
import org.ganoro.phing.ui.internal.dtd.IDfm;
import org.ganoro.phing.ui.internal.dtd.IElement;
import org.ganoro.phing.ui.internal.dtd.ISchema;
import org.ganoro.phing.ui.internal.dtd.ParseError;
import org.ganoro.phing.ui.internal.dtd.Parser;
import org.ganoro.phing.ui.internal.model.AntDefiningTaskNode;
...
public class AntEditorCompletionProcessor  extends TemplateCompletionProcessor implements ICompletionListener  {       
    ...
    private static final String ANT_DTD_FILENAME = "org/ganoro/phing/ui/editors/ant1.6.2.dtd"; //$NON-NLS-1$
    ...
    private ISchema parseDtd() throws ParseError, IOException {
        ...
        Reader reader= null;
        try {
        	stream= getClass().getResourceAsStream("ant1.6.2.dtd");
	...
	private ICompletionProposal[] determineProposals() {
		...
		if (prefix == null || cursorPosition == -1) {
			PhingUi.getStandardDisplay().beep();
			return NO_PROPOSALS;
		}
    ...
    protected ICompletionProposal[] getProposalsFromDocument(IDocument document, String prefix) {
        ...
        if (proposals.length > 0) {
        	errorMessage= IPhingCoreConstants.EMPTY_STRING;
        }
        return proposals;
    ...
    private ICompletionProposal[] getProjectAttributeValueProposals(String prefix, String attributeName) {
		if (attributeName.equalsIgnoreCase(IPhingCoreConstants.DEFAULT)) {
	...
	private void addAttributeProposal(String taskName, String prefix, List proposals, String attrName, String replacementString, String displayString, boolean lookupDescription) {
		...
		if (lookupDescription) {
			...
			if(description != null) {
			    proposalInfo = (proposalInfo == null ? IPhingCoreConstants.EMPTY_STRING : proposalInfo);
			    proposalInfo += description;
			}
		}
   ...
   protected ICompletionProposal[] getBuildFileProposals(IDocument document, String prefix) {
    ...
    private ICompletionProposal newCompletionProposal(IDocument document, String aPrefix, String elementName) {
    	elementName = elementName.replace("ant", "phing");
    ...
    protected String getPrefixFromDocument(String aDocumentText, int anOffset) {
        ...
        if (startOfWordToken != anOffset) {
            ...
            currentPrefix= IPhingCoreConstants.EMPTY_STRING;
        }
        return currentPrefix;
    }
    ...
    protected File getEditedFile() {
    	IWorkbenchPage page= PhingUi.getActivePage();
    	if (page == null) {
    		return null;
    	}
