...
public class AntTemplateAccess {
	...
	private static final String CUSTOM_TEMPLATES_KEY= "org.ganoro.phing.ui.editors.templates"; //$NON-NLS-1$
	...
	public TemplateStore getTemplateStore() {
		if (fStore == null) {
			fStore= new ContributionTemplateStore(getContextTypeRegistry(),PhingUi.getDefault().getPreferenceStore(), CUSTOM_TEMPLATES_KEY);
			try {
				fStore.load();
			} catch (IOException e) {
				PhingUi.log(e);
