...
import org.ganoro.phing.ui.editors.formatter.XmlDocumentFormatter;
...
public class AntAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	...
	private int getVisualTabLengthPreference() {
		return PhingUi.getDefault().getCombinedPreferenceStore().getInt(AbstractDecoratedTextEditorPreferenceConstants.EDITOR_TAB_WIDTH);
	}
}
